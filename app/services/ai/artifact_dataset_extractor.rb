# app/services/ai/artifact_dataset_extractor.rb
#
...
#
# Note:
# This lives under services/ai/ for now to keep the "artifact intelligence"
# near the AI pipeline. We can later move to a more general namespace.

module Ai
  class ArtifactDatasetExtractor
    ...
    def call
      ...
      Rails.logger.info("[Ai::ArtifactDatasetExtractor] failed: #{e.class}: #{e.message}")
