...
class OutputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create output" do
    assert_difference("Output.count") do
      post outputs_url, params: { output: { content: @output.content, kind: @output.kind, prompt_id: @output.prompt_id, status: @output.status } }
    end
  ...
  test "should update output" do
    patch output_url(@output), params: { output: { content: @output.content, kind: @output.kind, prompt_id: @output.prompt_id, status: @output.status } }
